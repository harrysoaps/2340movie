...
movies = [
    ...
    {
        'id' : 3, 'name' : 'The Dark Knight', 'price' : 14, 'description' : "Hero of Gotham faces the Joker"
    },
    {
        'id' : 4, 'name': 'Titanic', 'price' : 11, 'description' : 'A love story set against the backdrop of the Titanic.',
    }
